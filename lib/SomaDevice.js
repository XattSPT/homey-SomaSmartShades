...
class SomaShadeDevice extends Homey.Device {
    ...
    async updatestate (value, opts, dades) {
        ...
        try {
            ...
            if (update = "") this._syncTimeout = setTimeout(() => this.driver.updateDevice(this), settings.Refreshtime*1000)
            return
        }
        catch (error) {
            //await disconnectPeripheral()
    ...
    async updateposition (value, opts, dades) {
        ...
        /**
     * update motor speed to Soma
     * 
     */
         async updatespeed (value, opts, dades) {
